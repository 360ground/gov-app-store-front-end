  ...
  return (
    <div className="font-sans">
      ...
      <section className="py-8 bg-gray-100">
        <div className="container mx-auto text-center px-4 md:px-6 w-full lg:w-[960px]">
      ...
      <section className="py-8 bg-gray-100">
        <div className="container mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center w-full lg:w-[960px]">
      ...
      <section className="bg-blue-700 text-white py-10 md:py-16">
        <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 text-center gap-4 w-full lg:w-[960px]">
          <div>
      ...
      <section className="py-8 md:py-16 bg-gray-100">
        <div className="container mx-auto px-4 md:px-0 w-full lg:w-[960px]">
