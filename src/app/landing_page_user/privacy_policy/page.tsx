...
export default function AboutUs() {
  ...
  return (
    <div className="font-sans flex flex-col min-h-screen bg-gray-100">
      <div className="font-sans bg-blue-700">
        {/* Hero Section */}
        <section className=" text-white py-12 md:py-20 w-full lg:w-[960px] mx-auto px-4 md:px-0">
      ...
      <section className="py-8 flex-1 w-full lg:w-[960px] mx-auto min-h-screen">
        <p className='text-black mx-auto text-xl'>
