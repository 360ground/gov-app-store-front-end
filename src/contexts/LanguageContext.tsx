...
const translations: Translations = {
  en: {
    ...
    'cancel': 'Cancel',
    'ok': 'OK',
    'submission_successful': 'App Submitted Successfully!',
    'submission_message': 'Your app has been submitted for review. You will be notified once the review process is complete.',
    ...
    'gateway_message': 'Your Gateway to Official Government applications',
  ...
  am: {
    ...
    'cancel': 'ሰርዝ',
    'ok': 'እሺ',
    'submission_successful': 'መተግበሪያ በተሳካ ሁኔታ ተልኳል!',
    'submission_message': 'መተግበሪያዎ ለግምገማ ተልኳል። የግምገማ ሂደቱ እንደተጠናቀቀ ማሳወቂያ ይደርስዎታል።',
    ...
    'upload_files': 'ፋይሎችን ይስቀሉ',
    'app_description': 'የመተግበሪያ መግለጫ',
