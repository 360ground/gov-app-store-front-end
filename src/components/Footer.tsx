...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-100 ">
      <div className='w-full max-w-[960px] mx-auto py-5 px-5 lg:px-0'>
        <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center mb-6 gap-4">
          ...
          {/* Links Section */}
          <div className="flex flex-cols-2 justify-between gap-4 md:gap-8 text-[10px] lg:text-sm text-black w-full md:w-[20rem]">
            {/* Column 1 */}
            <div className=''>
        ...
        {/* Bottom Section */}
        <div className="pt-4 text-black flex flex-col justify-center items-center text-center text-[10px] lg:text-[12px]">
